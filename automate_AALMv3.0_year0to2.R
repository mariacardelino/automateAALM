...
print(head(par_df))
#190 rows, 19 variables (columns) for year 0-2
...
#COLUMN ORDER FOR TEXT FILE 0-2 YEAR:
# 1. BLDMOT
# 2. RDIFF
# 3. RCS2DF

# 4. RCORT0 - 0 to 3 months
# 5. RCORT03 - 3 to 12 months
# 6. RCORT1 - 13 to 24 months

# 7. RRBC0 - 0 to 3 months
# 8. RRBC03 - 3 to 12 months
# 9. RRBC1 - 13 to 24 months

# 10. SOIL0 - 0-12 months
# 11. SOIL1 - 13-24 months
# 12. DUST0 - 0-12 months
# 13. DUST1 - 13-24 months
# 14. WATER0 - 0-12 months
# 15. WATER1 - 13-24 months
# 16. AIR0 - 0-12 months
# 17. AIR1 - 13-24 months
# 18. FOOD0 - 0-12 months
# 19. FOOD1 - 13-24 months
...
age_range[["Value"]] <- paste("2") #change
gender_range[["Value"]] <- paste("Male")

for (x in 1:190) { #for each row of the df, run the model
...
library(tidyverse)
#desired output data
output_year0to2 <- combined_df %>%
  filter(Time_years == 2.000) %>%
  select(Iteration, Time_years, Blood_Pb, Bone_Pb, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13, X14, X15, X16, X17, X18, X19)


############ Write dataframe to a TXT file, CHANGE NAME ############################################### HERE ################
write.table(output_year0to2, "<output_file_name>", row.names = FALSE, sep = "\t") #write output file name